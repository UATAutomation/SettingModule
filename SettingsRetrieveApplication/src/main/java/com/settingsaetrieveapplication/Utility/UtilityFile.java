package com.settingsaetrieveapplication.Utility;
...
public class UtilityFile
{
	...
	public static void screenShot(WebDriver driver) 
	{
		...
		try {
			FileUtils.copyFile(src, new File("C:\\Users\\BASHA\\eclipse-workspace1\\SettingsRetrieveApplication\\Screenshort\\"+d+".png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
